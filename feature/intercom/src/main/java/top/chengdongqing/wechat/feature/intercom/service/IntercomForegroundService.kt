package top.chengdongqing.wechat.feature.intercom.service
...
class IntercomForegroundService : Service() {
    ...
    companion object {
        const val ACTION_JOIN =
            "top.chengdongqing.wechat.feature.intercom.action.JOIN"
        const val ACTION_LEAVE =
            "top.chengdongqing.wechat.feature.intercom.action.LEAVE"
