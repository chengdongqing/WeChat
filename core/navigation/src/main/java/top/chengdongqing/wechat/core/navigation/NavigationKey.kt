...
sealed interface NavigationKey : NavKey {
    ...
    @Serializable
    data object Main : NavigationKey
    ...
    @Serializable
    data class MusicPreview(val messageId: String, val trackName: String) : NavigationKey

    @Serializable
    data class LiveLocation(val chatId: String) : NavigationKey

    @Serializable
    data class GroupChat(val groupId: String) : NavigationKey

    @Serializable
    data class GroupInfo(val groupId: String) : NavigationKey

    @Serializable
    data object GroupList : NavigationKey
    ...
    @Serializable
    data object PhotographerCovers : NavigationKey
    ...
    @Serializable
    data object ContactTags : NavigationKey

    @Serializable
    data class EditContactTag(val tagId: String? = null) : NavigationKey

    @Serializable
    data class ManageContactTags(val contactId: String) : NavigationKey
    ...
    @Serializable
    data object StorageSettings : NavigationKey
